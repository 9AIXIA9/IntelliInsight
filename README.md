...
- ~~扩展Python-APP的交互功能~~
- 架构宏观扩展
- 接入metrics端点，暴露任务数、爬取速度等指标 提供可视化分析
- ~~分治处理多站点及大任务~~
- 一浏览器多Tab标签页爬取多站点
...
- 策略
	1. 规模 · 根据任务大小进行分治 如数据量为1000的任务分为5个200的小任务，分配到协程中运行 使用多个浏览器不同的账户爬取
	2. 来源 · 根据任务需求爬取不同站点 如一个协程爬取小红书一个爬取知乎 使用一个浏览器的多个标签页不同的站点爬取
- 设计
